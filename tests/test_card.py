...
@pytest.mark.parametrize(
    "rank0,cost0,suit0,face_down0",
    [
        ("King", 10, "Hearts", False),
        ("King", 10, "Spades", False),
        ("Two", 2, "Clubs", True),
    ],
)
...
@pytest.mark.parametrize(
    "rank0,cost0,suit0,face_down0",
    [("King", 10, 0, False), ("King", 10, "ERROR", False)],
)
...
@pytest.mark.parametrize(
    "rank0,cost0,suit0,face_down0",
    [
        ("prince", 10, "Hearts", False),
        ("Ralsei", 10, "Hearts", False),
        (404, 10, "Spades", False),
    ],
)
